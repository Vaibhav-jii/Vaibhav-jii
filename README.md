...
- **[iLumina](https://github.com/Vaibhav-jii/iLumina)** — Multi-agent RAG document-intelligence system. Dual-agent LangGraph pipeline (Research + Expert Writer) routing across Groq, Gemini, and NVIDIA NIM, with MCP servers for filesystem, browsing, and memory.
...
**AI/ML:** LangChain, LangGraph, RAG, MCP, ChromaDB, Ollama, Llama-3, Gemini, Groq, NVIDIA NIM

**Backend/Infra:** FastAPI, Docker, Git, GitHub, Jenkins
